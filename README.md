...
CRM IAM BI Consolidation Brief is a Kinetic Gain benchmark-pack repo for enterprise platform and company signals.
...
`json
{
  "product": "CRM IAM BI Consolidation Brief",
